...
import { ProductRatingContract, ProductRatingRefs, ProductRatingSlowViewState, ProductRatingFastViewState, ProductRatingInteractiveViewState } from './product-rating.jay-contract';
...
export const productRating = makeJayStackComponent<ProductRatingContract>()
    ...
    .withInteractive((props: Props<ProductRatingProps>, refs: ProductRatingRefs, fastViewState: Signals<ProductRatingFastViewState>, carryForward: RatingCarryForward ) => {
        ...
        const userRating = createMemo(() => userRatingValue() > 0? ""+userRatingValue() : "")
