...
export type GeminiChatFastViewState = Pick<
    GeminiChatViewState,
    | 'lastUserMessage'
...
export type GeminiChatInteractiveViewState = Pick<
    GeminiChatViewState,
    | 'lastUserMessage'
    | 'lastAssistantMessage'
    | 'messageInput'
...
export type GeminiChatContract = JayContract<
    GeminiChatViewState,
    GeminiChatRefs,
    GeminiChatSlowViewState,
