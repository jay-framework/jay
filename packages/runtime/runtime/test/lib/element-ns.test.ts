...
describe('elements with namespace', () => {
    describe('svg', () => {
        ...
        function mkSvgElement(vs: ViewState) {
            ...
            const jayElement = ConstructContext.withRootContext(vs, refManager, () =>
                svg('svg', { width: '200', height: '200', viewBox: '0 0 200' }, [
                    svg(
                        'circle',
                        { cx: '100', cy: '100', r: '50', fill: da((vs) => vs.color) },
                        [],
                        ref1(),
                    ),
                ]),
        ...
        it('should create svg element', () => {
            ...
            expect(jayElement.dom.outerHTML).toBe(
                '<svg width="200" height="200" viewBox="0 0 200"><circle cx="100" cy="100" r="50" fill="blue"></circle></svg>',
            );
        });
        ...
        it('should support dynamic attribute', () => {
            ...
            expect(jayElement.dom.outerHTML).toBe(
                '<svg width="200" height="200" viewBox="0 0 200"><circle cx="100" cy="100" r="50" fill="red"></circle></svg>',
            );
        });
