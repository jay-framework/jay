import {EventEmitter, JayEventHandler} from "../../../lib";

export function mkComponentEventHandler<EventType, PropsType>(): EventEmitter<EventType, PropsType> {
  ...
  eventDefinition.emit = (event: EventType) => _handler && _handler({
    event,
    viewState: undefined,
