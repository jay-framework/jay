...
import { validateStructure } from '../../lib/validators/design-structure.js';
        ...
        expect(findings).toEqual([
            {
                ...
                suggestion: 'Reduce to 1 primary action button per page. Same button (same ref and text) appearing multiple times counts as one.',
            },
        ]);
    });
