...
export interface BasicRef<ParentVS> extends JayComponent<
...
export interface BasicRefs<ParentVS> extends ComponentCollectionProxy<ParentVS, BasicRef<ParentVS>> {
