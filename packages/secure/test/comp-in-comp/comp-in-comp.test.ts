...
describe('comp in comp - parent child communication', () => {
    ...
    async function mkElement() {
        ...
        let eventToParentButton = (id) => appElement.dom.querySelector(`#event-to-parent-button-${id}`) as HTMLButtonElement
        let eventToParentToChildPropButton = (id) => appElement.dom.querySelector(`#event-to-parent-to-child-prop-button-${id}`) as HTMLButtonElement
        let eventToParentToChildAPIButton = (id) => appElement.dom.querySelector(`#event-to-parent-to-child-api-button-${id}`) as HTMLButtonElement
    ...
    describe('parent to static child communication', () => {
        ...
        it('should support parent calling child API', async () => {
            ...
            expect(childTextFromAPI(STATIC_ID).textContent)
