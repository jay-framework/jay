...
export interface TreeComponent<ParentVS> extends JayComponent<
    Node,
    TreeNodeViewState,
    TreeNodeElement
> {
...
export interface TreeComponentCollection<ParentVS> extends ComponentCollectionProxy<
    ParentVS,
    TreeComponent<ParentVS>
> {
    onChange: EventEmitter<number, ParentVS>;
}
