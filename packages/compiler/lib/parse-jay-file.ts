...
function resolveType(data: any, validations: JayValidations, path: Array<string>): JayObjectType {
  ...
  for (let prop in data) {
    if (typesMap[data[prop]] !== undefined) types[prop] = typesMap[data[prop]];
