...
export function equalJayTypes(a: JayType, b: JayType) {
    ...
    if (a instanceof JayAtomicType && b instanceof JayAtomicType)
        ...
        return a.values.length === b.values.length &&
            a.values.reduce((res, a_val, currentIndex) => res && a_val === b.values[currentIndex], true);
        ...
        return a.api.length === b.api.length &&
            a.api.reduce((res, a_val, currentIndex) =>
                res &&
                a_val.property === b.api[currentIndex].property &&
                a_val.isEvent === b.api[currentIndex].isEvent, true)
        ...
        return aProps.size === bProps.size &&
        ...
        return a.ofTypes.length === b.ofTypes.length &&
