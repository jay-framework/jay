    ...
    describe('array', () => {
        ...
        describe('flat', () => {
            ...
            it('should support flat', () => {
                ...
                // @ts-ignore
                expect(mutableArr.flat()).toEqual([
                    { a: 1, b: 2 },
                    { a: 3, b: 4 },
                    { a: 5, b: 6 },
                ]);
        ...
        describe('flatMap', () => {
            ...
            it('on objects', () => {
                ...
                // @ts-ignore
                expect(mutableArr.flatMap((x) => [{ a: x.a }, { b: x.b }])).toEqual([
                    { a: 1 },
                    { b: 2 },
                    { a: 3 },
                    { b: 4 },
        ...
        describe('forEach', () => {
            ...
            it('should support objects', () => {
                ...
                let found = 0;
                const handleItem = (_) => {
                    if (_ === item0 || _ === item1 || _ === item2) found += 1;
                };
        ...
        describe('map', () => {
            ...
            it('on objects', () => {
                ...
                const result = mutableArr.map((item) => {
                    item.a *= 2;
                    return item;
                });
