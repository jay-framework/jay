...
import {CounterElement, CounterElementProps, CounterElementViewState} from "./counter-element.tsx";
...
export const CounterBridge =
    ComponentBridge<CounterElementViewState, CounterProps, CounterElementProps>(CounterElement);