...
import {MediaItemViewState, MediaItemRefs, MediaItemRepeatedRefs} from "./media-item.jay-contract";
...
export type ProductPageElementRender = RenderElement<ProductPageViewState, ProductPageRefs, ProductPageElement>
