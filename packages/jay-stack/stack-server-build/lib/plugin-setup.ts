...
import { scanPlugins, type ScannedPlugin } from '@jay-framework/stack-server-runtime';
import { getServiceRegistry } from '@jay-framework/stack-server-runtime';
import type { ViteSSRLoader } from '@jay-framework/stack-server-runtime';
import { getLogger } from '@jay-framework/logger';
import { sortPluginsByDependencies } from '@jay-framework/stack-server-runtime';
import type {
    PluginSetupPrompt,
    PluginSetupContext,
    PluginSetupHandler,
    ...
    PluginAgentKitHandler,
    PluginAgentKitResult,
} from '@jay-framework/stack-server-runtime';

// Re-export plugin-facing contract types for consumers that import them from
// stack-server-build (the definitions live in stack-server-runtime — DL#178).
export type {
    PluginSetupPrompt,
    PluginSetupContext,
    PluginSetupResult,
